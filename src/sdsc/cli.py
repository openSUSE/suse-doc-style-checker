...
def printcolor(message, errortype=None):
    ...
    if sys.stdout.isatty():
        if errortype == 'error':
            msg = '\033[0;31m{}\033[0m'.format(message)
        else:
            msg = '\033[0;32m{}\033[0m'.format(message)
    else:
        msg = message

    # toms: Shouldn't this return the message instead of printing it?
    print(msg)
